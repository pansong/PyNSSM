...
def training_loop(n_epochs, state_net, output_net, state_optimizer, output_optimizer, criterion, dataloader, dt, state_size, output_size, data_folder, device, x_zero_scaled):
    state_losses = []
    output_losses = []
...
if __name__ == "__main__":
    ...
    training_loop(EPOCHS, state_net, output_net, optimizer_state, optimizer_output, criterion, dataloader, DT, STATE_SIZE, OUTPUT_SIZE, RESULTS_DIR, device, x_zero_scaled)
